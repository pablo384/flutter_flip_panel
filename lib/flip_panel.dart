...
class FlipClock extends StatelessWidget {
  ...
  _buildSegment(Stream<DateTime?> timeStream, int Function(DateTime?) tensDigit,
      int Function(DateTime?) onesDigit, DateTime? startTime, String id) {
    return Column(
      children: <Widget>[
        Row(children: [
          Padding(
...
class FlipPanel<T> extends StatefulWidget {
  ...
  FlipPanel.stream({
    Key? key,
    required Stream<T> this.itemStream,
